function createRainAnimation(targetElement) {
    ...
    function mainLoop() {
        ...
        ctx.fillText("John 8:12", w - 100, 492);
    }

    // canvas positioning and sizing
    function updatePosition() {
        var bodyWidth = targetElement.clientWidth,
            bodyHeight = targetElement.clientHeight;
    ...
    function lamp() {
        ...
        var grdCross = ctx.createLinearGradient(150, 210, 150, 500);
        grdCross.addColorStop(0.000, 'rgba(60, 60, 60, 1.000)');
        grdCross.addColorStop(0.2, 'rgba(80, 80, 80, 1.000)');
        grdCross.addColorStop(1, 'rgba(45, 45, 45, 1.000)');
        ctx.fillStyle = grdCross;
        ctx.fillRect(150, 300, 200, 6);

        var grdCrossOuterHigh = ctx.createLinearGradient(150, 210, 150, 500);
        grdCrossOuterHigh.addColorStop(0.000, 'rgba(65, 65, 65, 1.000)');
        grdCrossOuterHigh.addColorStop(0.2, 'rgba(95, 95, 95, 1.000)');
        grdCrossOuterHigh.addColorStop(1, 'rgba(47, 47, 47, 1.000)');
        ctx.fillStyle = grdCrossOuterHigh;
        ctx.fillRect(150, 299, 200, 1);

        var grdCrossOuterLow = ctx.createLinearGradient(150, 210, 150, 500);
        grdCrossOuterLow.addColorStop(0.000, 'rgba(45, 45, 45, 1.000)');
        grdCrossOuterLow.addColorStop(0.2, 'rgba(60, 60, 60, 1.000)');
        grdCrossOuterLow.addColorStop(1, 'rgba(43, 43, 43, 1.000)');
        ctx.fillStyle = grdCrossOuterLow;
        ctx.fillRect(150, 306, 200, 1);
    ...
    // function to position and color each raindrop
    ...
    function rain() {
        for (var i = 0; i < 500; i++) {
            ...
            grd.addColorStop(0.000, 'rgba(100, 170, 160, 0.12)');
            grd.addColorStop(0.1, 'rgba(100, 160, 160, 0.22)');
            grd.addColorStop(0.2, 'rgba(100, 150, 150, 0.2)');
            grd.addColorStop(1, 'rgba(100, 140, 140, .18)');
            ctx.fillStyle = grd;
